...
const recommendedCars: Car[] = [
  {
    id: 1,
    name: "Toyota Yaris (Eco)",
    price: 800,
    type: "รถเก๋ง 4 ที่นั่ง",
  ...
  },
  {
    ...
    name: "BYD Atto 3 (EV)",
    price: 1800,
    type: "รถพลังงานไฟฟ้า 100%",
    img: "https://images.unsplash.com/photo-1672846727402-1fa8d338fbc9?auto=format&fit=crop&w=800&q=80",
  },
  {
    id: 4,
    name: "Toyota Fortuner",
    price: 2500,
    type: "รถครอบครัว 7 ที่นั่ง",
    img: "https://images.unsplash.com/photo-1550482782-5f60dc8a7a85?auto=format&fit=crop&w=800&q=80",
  },
];
    ...
    <div className="bg-slate-50 text-blue-950 min-h-screen font-sans selection:bg-blue-200">
      <main className="pb-20">
        ...
        <section className="relative w-full h-[65vh] min-h-[550px] flex flex-col items-center justify-center">
          ...
          {/* 🌟 เปลี่ยนเป็น Form เพื่อส่งค่าไปหน้า /cars ด้วย method GET */}
          <form
            action="/cars"
            method="GET"
          ...
          >
            {/* 🌟 รวบเป็น: สถานที่รับ-คืนรถ (ช่องเดียว) */}
            ...
            <button
              type="submit"
              className="w-full md:w-auto bg-blue-600 hover:bg-blue-700 text-white p-4 rounded-full flex items-center justify-center transition-all duration-300 shadow-[0_4px_14px_0_rgba(37,99,235,0.39)] md:aspect-square group"
            >
              <svg
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            ...
            <div>
              <h2 className="text-3xl md:text-4xl font-extrabold text-blue-950 mb-6 leading-tight">
                ความสมบูรณ์แบบ
                <br />
                ในทุก<span className="text-blue-600">การขับขี่</span>
              </h2>
              <p className="text-slate-600 text-lg mb-6 leading-relaxed font-light">
                สัมผัสประสบการณ์การเดินทางที่เหนือกว่า
                แพลตฟอร์มของเราคัดสรรเฉพาะรถยนต์สภาพเยี่ยม
                ไม่ว่าจะเป็นการเดินทางเพื่อธุรกิจใน <strong>กรุงเทพ</strong>{" "}
                หรือพักผ่อนใน <strong>เชียงใหม่ และภูเก็ต</strong>{" "}
                เราพร้อมมอบความหรูหราที่เข้าถึงได้
              </p>
              ...
              <p className="text-slate-600 leading-relaxed font-light">
                ...
                พร้อมตัวเลือกรถพลังงานสะอาด (EV)
                ที่ช่วยให้คุณดูดีพร้อมรักษ์โลกไปในตัว
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="max-w-7xl mx-auto px-6 py-20">
          <h2 className="text-3xl font-extrabold text-blue-950 mb-10 text-center">
            สิทธิพิเศษสำหรับคุณ
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {promotions.map((promo) => (
              <div
                key={promo.id}
                className={`bg-gradient-to-br ${promo.gradient} border rounded-2xl p-8 text-white relative overflow-hidden group cursor-pointer hover:-translate-y-2 transition-all duration-300 shadow-xl`}
              >
